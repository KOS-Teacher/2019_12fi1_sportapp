    ...
    <main>
        ...
        <div class="d-flex justify-content-center" style="height: 40%;">
            <form style="text-align: center;max-height: 100%;"><input type="file" style="/*height: 90px;*//*width: 90px;*/">
                ...
                <div style="margin-top: 25px;"><button class="btn btn-green" id="btnCheckliste" type="button" style="width: 125px;margin-right: 65px;">Checkliste</button><button class="btn btn-green" id="btnAbsenden" onclick="stationScannen()" type="button" style="width: 125px;">Absenden</button></div>
            </form>
        </div>
    </main>
    <footer></footer>
