    ...
    <main class="text-center">
        ...
        <div class="d-flex justify-content-center">
            <div style="width: 180px;">
                ...
                </div><label class="label" style="float: left;">Inaktiv:</label><label id="txtInaktiv" class="text" style="float: right;">15</label>
                <div class="space"></div><label class="label" style="float: left;">Krank:</label><label id="txtKrank" class="text" style="float: right;">5</label></div>
        </div>
        <div class="d-flex justify-content-center">
