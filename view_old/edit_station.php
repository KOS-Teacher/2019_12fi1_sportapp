...
<body>
    ...
    <main>
        ...
        <div><button class="btn btn-red" id="btnVerwerfen" onclick="verwerfen()" type="button" style="width: 100px;">Verwerfen</button>
        <button class="btn btn-green" id="btnSpeichern" onclick="speichern()" type="button" style="width: 99px;">Speichern</button></div>
        </form>
        </div>
    </main>
    <footer></footer>
    ...
    <script type="text/javascript" src="../js/edit_station.js"></script>
</body>
